...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Jamal Ahmad Ansari";
...
var typed = new Typed(".typing-text", {
    strings: ["Frontend Development", "Software Development", "Web Development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
var typed2 = new Typed(".typing-header", {
    strings: ["Jamal Ahmad Ansari", "Proud Indian", "Responsive WebD Intern", ],
    loop: true,
    typeSpeed: 100,
    backSpeed: 50,
    backDelay: 1000,
